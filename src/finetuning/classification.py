...
if __name__ == "__main__":
    ...
    if args.context_length == "model_context_length":
        ...
        train_dataset = IMDBDataset(base_path / "data/classification/train.csv", max_length=None, tokenizer=tokenizer)
    ...
    if train_dataset is None:
        train_dataset = IMDBDataset(base_path / "data/classification/train.csv", max_length=max_length, tokenizer=tokenizer)
    val_dataset = IMDBDataset(base_path / "data/classification/validation.csv", max_length=max_length, tokenizer=tokenizer)
    test_dataset = IMDBDataset(base_path / "data/classification/test.csv", max_length=max_length, tokenizer=tokenizer)
    ...
    model_save_path = "models/classification_model.pth"
    ...
    metrics_save_path = "models/classification_train_metrics.json"
